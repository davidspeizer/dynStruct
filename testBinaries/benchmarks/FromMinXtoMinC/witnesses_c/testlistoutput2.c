...
int First(int* x19);
struct3* FindPrevious(int x12,struct3* x13);
char* list_istr3();
char* list_istr2();
char* list_istr1();
char* list_istr0();
int DeleteList(struct3* x17);
int* Find(int x8,struct3* x9);
int Delete(int x10,struct3* x11);
int Insert(int x14,int* x15,struct3* x16);
struct3* MakeEmpty(struct3* x4);
int main(int x2,char** x3);
int IsLast(struct3* x6,int* x7);
int Retrieve(int* x21);
struct3* Advance(struct3* x20);
int IsEmpty(struct3* x5);
struct3* Header(struct3* x18);
int PrintList(struct3* x1);
char* testlist_istr4();
char* testlist_istr3();
char* testlist_istr2();
char* testlist_istr1();
...
int Insert(int x14,int* x15,struct3* x16) {
  ...
  struct3* y144;
  label__BB000:
            y137 = (struct3*) malloc(sizeof(struct3));
...
struct3* MakeEmpty(struct3* x4) {
  ...
  label__BB000:
            ...
            goto label__BB17;
  label__BB0:
            x4 = (struct3*) malloc(sizeof(struct3));
