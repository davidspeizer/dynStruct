...
// This is called every time we see a `call`. This creates a replica of the call stack.
// In this way, whenever we see a malloc we can look at our stack to see the function that called it.
...
// Populates address, sym, and module.
                     ...
                     void *drcontext, int alloc)
{
  ...
  if (func->on_plt)
  {
    printf("Search tree for PLT and address %p\n", func->addr);
